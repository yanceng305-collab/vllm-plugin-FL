...
from vllm_fl.dispatch.backends.vendor.ascend.attention.utils import maybe_save_kv_layer_to_connector
from vllm_fl.dispatch.backends.vendor.ascend.compilation.acl_graph import (
    get_draft_graph_params,
    get_graph_params,
)
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.fla.chunk import chunk_gated_delta_rule
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.fla.fused_qkvzba_split_reshape import fused_qkvzba_split_reshape_cat
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.fla.utils import clear_ssm_states
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.fused_gdn_gating import fused_gdn_gating_patch
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.mamba.causal_conv1d import causal_conv1d_fn
from vllm_fl.dispatch.backends.vendor.ascend.utils import vllm_version_is, weak_ref_tensors
...
def update_conv1d_graph_params(
    ...
    from vllm_fl.dispatch.backends.vendor.ascend.compilation.acl_graph import get_draft_graph_params, get_graph_params
...
class AscendGatedDeltaNetAttention(GatedDeltaNetAttention):
    ...
    def _forward_core(
        ...
        if spec_sequence_masks is not None:
            ...
            # Dispatches to the vllm-plugin-FL AscendC custom operator
