...
from vllm_fl.dispatch.backends.vendor.ascend.ops.rotary_embedding import rope_forward_oot
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.muls_add import muls_add_triton
from vllm_fl.dispatch.backends.vendor.ascend.ops.weight_prefetch import maybe_npu_prefetch
from vllm_fl.dispatch.backends.vendor.ascend.utils import enable_sp_by_pass, is_vl_model, npu_stream_switch, prefetch_stream
