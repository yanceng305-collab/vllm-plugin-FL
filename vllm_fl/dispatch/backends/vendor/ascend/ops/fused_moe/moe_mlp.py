...
from vllm_fl.dispatch.backends.vendor.ascend.ops.activation import AscendSwigluOAIAndMul
from vllm_fl.dispatch.backends.vendor.ascend.ops.fused_moe.moe_runtime_args import MoEMlpComputeInput
...
def quant_apply_mlp(
    ...
    if w1_scale_bias is None and w1_offset is None and is_mc2:
        ...
        if use_w4a8_per_channel_gmm_swiglu and enable_custom_op():
            ...
            # act_fn: swiglu
            if HAS_TRITON:
                from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.activation.swiglu_quant import swiglu_quant
