...
from vllm_fl.dispatch.backends.vendor.ascend.ascend_forward_context import _EXTRA_CTX, MoECommType
from vllm_fl.dispatch.backends.vendor.ascend.distributed.parallel_state import get_mc2_group
from vllm_fl.dispatch.backends.vendor.ascend.eplb.core.eplb_utils import init_eplb_config
from vllm_fl.dispatch.backends.vendor.ascend.flash_common3_context import get_flash_common3_context, set_flash_common3_context
from vllm_fl.dispatch.backends.vendor.ascend.ops.fused_moe.experts_selector import select_experts, zero_experts_compute
from vllm_fl.dispatch.backends.vendor.ascend.ops.fused_moe.moe_comm_method import AllGatherCommImpl, FusedExpertsResult, setup_moe_comm_method
from vllm_fl.dispatch.backends.vendor.ascend.ops.fused_moe.moe_runtime_args import build_fused_experts_input
from vllm_fl.dispatch.backends.vendor.ascend.quantization.methods.base import get_moe_num_logical_experts
from vllm_fl.dispatch.backends.vendor.ascend.quantization.quant_type import QuantType
...
class AscendFusedMoE(FusedMoE):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # to 1.0 and expects the runner to apply scaling to output. But vllm-plugin-FL
    ...
    def use_dp_chunking(self) -> bool:
        ...
        only when data parallelism (DP) is enabled. Thus just returning False in vllm-plugin-FL
        """
        return False
