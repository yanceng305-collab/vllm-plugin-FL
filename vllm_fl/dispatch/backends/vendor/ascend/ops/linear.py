...
from vllm_fl.dispatch.backends.vendor.ascend.ops.linear_op import get_parallel_op, get_replicated_op
from vllm_fl.dispatch.backends.vendor.ascend.utils import enable_sp, maybe_trans_nz
