...
from vllm_fl.dispatch.backends.vendor.ascend.platform import NPUPlatform
from vllm_fl.dispatch.backends.vendor.ascend.utils import has_rope, is_vl_model

if HAS_TRITON:
    from vllm.model_executor.layers.rotary_embedding.mrope import triton_mrope

    from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.rope import rope_forward_triton
