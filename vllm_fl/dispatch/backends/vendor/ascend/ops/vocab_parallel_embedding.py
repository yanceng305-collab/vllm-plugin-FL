...
from vllm_fl.dispatch.backends.vendor.ascend.distributed.parallel_state import get_embed_tp_group, get_lmhead_tp_group
from vllm_fl.dispatch.backends.vendor.ascend.utils import embedding_tp_enable, lmhead_tp_enable
