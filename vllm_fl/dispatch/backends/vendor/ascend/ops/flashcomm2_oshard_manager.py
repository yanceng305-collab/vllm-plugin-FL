...
from vllm_fl.dispatch.backends.vendor.ascend.distributed.parallel_state import get_shard_weight_group
...
from vllm_fl.dispatch.backends.vendor.ascend.utils import flashcomm2_enable, o_shard_enable
