...
from vllm_fl.dispatch.backends.vendor.ascend.utils import is_vl_model, parse_layer_idx
...
class AscendMultiHeadLatentAttention(MultiHeadLatentAttentionWrapper):
    def __init__(
        ...
        def wrapped_process_weights(act_dtype: torch.dtype):
            from vllm_fl.dispatch.backends.vendor.ascend.attention.sfa_v1 import AscendSFAImpl
