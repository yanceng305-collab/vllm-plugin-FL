...
def _patch_speculative_minimax_whitelist() -> None:
    ...
    if original_verify_args is None:
        ...
        return
    if getattr(original_verify_args, "_fl_ascend_minimax_eagle3_patched", False):
    ...
    _patched_verify_args._fl_ascend_minimax_eagle3_patched = True  # type: ignore[attr-defined]
