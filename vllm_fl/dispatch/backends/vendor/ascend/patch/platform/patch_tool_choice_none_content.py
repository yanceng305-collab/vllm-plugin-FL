...
_NO_FORCED_TOOL_CALL = "_fl_ascend_no_forced_tool_call"
...
def _patch_named_tool_choice_bool() -> None:
    if getattr(ChatCompletionNamedToolChoiceParam, "_fl_ascend_bool_patched", False):
        return
    ...
    ChatCompletionNamedToolChoiceParam._fl_ascend_bool_patched = True
