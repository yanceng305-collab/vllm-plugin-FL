...
from vllm_fl.dispatch.backends.vendor.ascend.distributed.device_communicators.npu_communicator import NPUCommunicator
from vllm_fl.dispatch.backends.vendor.ascend.patch.worker._hccl_pg_registry import HcclPgRegistry, make_hccl_pg_key
from vllm_fl.dispatch.backends.vendor.ascend.utils import create_hccl_pg_options
