...
from vllm_fl.dispatch.backends.vendor.ascend.ops.rotary_embedding import get_cos_and_sin_slice
...
if not getattr(_original_minimax_m2_forward, "_fl_ascend_minimax_eagle3_patched", False):
    MiniMaxM2Model.forward = _patched_minimax_m2_forward  # type: ignore[assignment]
    MiniMaxM2Model.forward._fl_ascend_minimax_eagle3_patched = True  # type: ignore[attr-defined]
