...
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.fla.layernorm_guard import LayerNormFn
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.fla.sigmoid_gating import fused_recurrent_gated_delta_rule_fwd_kernel
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.mamba.causal_conv1d import causal_conv1d_fn, causal_conv1d_update_npu
