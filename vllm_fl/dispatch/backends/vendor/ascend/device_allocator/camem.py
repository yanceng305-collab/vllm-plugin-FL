...
# Sleep-mode memory management requires the native Ascend memory module
# (init_module / python_create_and_map / python_unmap_and_release). Those
# symbols are not exposed when the kernels are loaded via torch.ops.load_library,
# so sleep mode is disabled in this build.
