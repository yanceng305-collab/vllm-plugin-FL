...
from vllm_fl.dispatch.backends.vendor.ascend.ascend_forward_context import _EXTRA_CTX, set_ascend_forward_context
...
from vllm_fl.dispatch.backends.vendor.ascend.attention.utils import AscendCommonAttentionMetadata
from vllm_fl.dispatch.backends.vendor.ascend.compilation.acl_graph import ACLGraphWrapper, update_full_graph_params
from vllm_fl.dispatch.backends.vendor.ascend.distributed.parallel_state import get_lmhead_tp_group
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.spec_decode.utils import prepare_inputs_padded_kernel
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.triton_utils import get_vectorcore_num
from vllm_fl.dispatch.backends.vendor.ascend.utils import enable_sp, lmhead_tp_enable, shared_expert_dp_enabled
...
class AscendSpecDecodeBaseProposer(SpecDecodeBaseProposer):
    ...
    def attn_update_stack_num_spec_norm(
        ...
        assert draft_step > 0
        assert attn_group is not None, "vllm-plugin-FL v0.17.0rc1 requires attn_group"
        ...
        if self.pcp_size * self.dcp_size > 1:
            ...
            # However, in vllm-plugin-FL, the above value can be multiple of `kernel_block_size`,
