...
from vllm_fl.dispatch.backends.vendor.ascend.attention.attention_v1 import AscendMetadata
from vllm_fl.dispatch.backends.vendor.ascend.utils import ACL_FORMAT_FRACTAL_NZ, nd_to_nz_2d, nd_to_nz_spec
