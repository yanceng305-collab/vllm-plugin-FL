...
from vllm_fl.dispatch.backends.vendor.ascend._310p.model_runner_310p import NPUModelRunner310
from vllm_fl.dispatch.backends.vendor.ascend.worker.worker import NPUWorker, init_workspace_manager
...
class NPUWorker310(NPUWorker):
    ...
    def save_sharded_state(
        ...
        from vllm_fl.dispatch.backends.vendor.ascend._310p.sharded_state_loader_310p import ShardedStateLoader310
