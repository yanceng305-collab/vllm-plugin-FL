...
from vllm_fl.dispatch.backends.vendor.ascend._310p.quantization.methods.registry import (
    get_scheme_class,
)
from vllm_fl.dispatch.backends.vendor.ascend.quantization.method_adapters import AscendFusedMoEMethod, AscendLinearMethod
from vllm_fl.dispatch.backends.vendor.ascend.quantization.modelslim_config import (
    AscendModelSlimConfig,
    get_quant_type_for_layer,
    packed_modules_model_mapping,
)
from vllm_fl.dispatch.backends.vendor.ascend.utils import ASCEND_QUANTIZATION_METHOD
...
def create_scheme_for_layer(
    ...
    """
    logger.info_once("Using the vllm-plugin-FL modelslim Quantization now!")
    ...
    err_msg = f"Currently, vllm-plugin-FL doesn't support quant_type={quant_type} for layer_type={layer_type}."
    logger.error(err_msg)
    ...
    def get_quant_method(
        ...
        if isinstance(layer, LinearBase):
            ...
            if self.is_layer_skipped_ascend(prefix, self.packed_modules_mapping):
                from vllm_fl.dispatch.backends.vendor.ascend._310p.fused_moe.fused_moe import AscendUnquantizedFusedMoEMethod310
            ...
            from vllm_fl.dispatch.backends.vendor.ascend._310p.ops.vocab_parallel_embedding import AscendUnquantizedEmbeddingMethod310
