...
from vllm_fl.dispatch.backends.vendor.ascend.ops.fused_moe.experts_selector import zero_experts_compute
from vllm_fl.dispatch.backends.vendor.ascend.ops.fused_moe.moe_comm_method import (
    AllGatherCommImpl,
    FusedExpertsResult,
    _MoECommMethods,
)
...
class AscendFusedMoE310(FusedMoE):
    def __init__(self, *args, **kwargs):
        ...
        from vllm_fl.dispatch.backends.vendor.ascend.ops.fused_moe.fused_moe import AscendMoERunner
