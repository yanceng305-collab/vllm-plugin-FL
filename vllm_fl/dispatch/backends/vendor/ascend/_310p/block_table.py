...
from vllm_fl.dispatch.backends.vendor.ascend.worker.block_table import BlockTable as AscendBlockTable
from vllm_fl.dispatch.backends.vendor.ascend.worker.block_table import MultiGroupBlockTable as AscendMultiGroupBlockTable
