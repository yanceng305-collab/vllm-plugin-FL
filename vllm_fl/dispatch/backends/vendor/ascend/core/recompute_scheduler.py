...
class RecomputeSchedulerConfig(SchedulerConfig):
    scheduler_cls: str | type[object] = "vllm_fl.dispatch.backends.vendor.ascend.core.recompute_scheduler.RecomputeScheduler"
    ...
    def initialize_from_config(cls, vllm_config: VllmConfig):
        ...
        if vllm_scheduler_config.async_scheduling:
            scheduler_config["scheduler_cls"] = "vllm_fl.dispatch.backends.vendor.ascend.core.recompute_scheduler.AsyncRecomputeScheduler"
        else:
            scheduler_config["scheduler_cls"] = "vllm_fl.dispatch.backends.vendor.ascend.core.recompute_scheduler.RecomputeScheduler"
