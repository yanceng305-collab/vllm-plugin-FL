...
from vllm_fl.dispatch.backends.vendor.ascend.sample.penalties import apply_all_penalties
from vllm_fl.dispatch.backends.vendor.ascend.utils import AscendDeviceType, get_ascend_device_type, global_stream, npu_stream_switch
...
class AscendSampler(Sampler):
    ...
    def __init__(self, logprobs_mode=DEFAULT_LOGPROBS_MODE):
        # TODO: support logprobs_mode in vllm-plugin-FL
