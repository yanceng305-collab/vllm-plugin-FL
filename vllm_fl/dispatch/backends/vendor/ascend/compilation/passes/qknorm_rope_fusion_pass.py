...
from vllm_fl.dispatch.backends.vendor.ascend.compilation.passes.base_pattern import BasePattern
from vllm_fl.dispatch.backends.vendor.ascend.utils import get_rope_dim
