...
from vllm_fl.dispatch.backends.vendor.ascend.eplb.core.eplb_utils import generate_log2phy_map
from vllm_fl.dispatch.backends.vendor.ascend.eplb.core.policy.policy_factory import PolicyFactory
...
class EplbProcess:
    ...
    def worker_process(self, planner_q, block_update_q):
        ...
        if self.policy_type == 3:
            from vllm_fl.dispatch.backends.vendor.ascend.eplb.core.policy.policy_flashlb import warm_up
