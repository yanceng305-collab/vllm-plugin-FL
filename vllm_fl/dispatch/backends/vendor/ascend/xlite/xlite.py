...
#
"""Xlite integration module for vllm-plugin-FL."""
...
from vllm_fl.dispatch.backends.vendor.ascend.attention.attention_v1 import AscendAttentionState, AscendMetadata
from vllm_fl.dispatch.backends.vendor.ascend.xlite.utils import _get_nested_attr, rgetattr
...
class XliteWrapper:
    ...
    def __call__(
        ...
        if use_xlite_graph:
            # TODO: When vllm_fl.dispatch.backends.vendor.ascend enables graph mode, attn_metadata.num_decodes
