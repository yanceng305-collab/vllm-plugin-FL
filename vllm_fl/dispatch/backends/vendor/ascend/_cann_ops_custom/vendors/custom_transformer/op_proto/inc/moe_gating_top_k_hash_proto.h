#ifndef MOE_GATING_TOP_K_HASH_PROTO_H_
#define MOE_GATING_TOP_K_HASH_PROTO_H_
...
REG_OP(MoeGatingTopKHash)
    ...
    .OPTIONAL_INPUT(input_ids, ge::TensorType::ALL())
    .OPTIONAL_INPUT(tid2eid, ge::TensorType::ALL())
