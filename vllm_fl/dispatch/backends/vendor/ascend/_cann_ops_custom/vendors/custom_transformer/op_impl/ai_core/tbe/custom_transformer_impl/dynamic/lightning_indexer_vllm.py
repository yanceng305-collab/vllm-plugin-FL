...
@tbe_register.register_operator("LightningIndexerVllm", trans_bool_to_s8=False)
...
def lightning_indexer_vllm(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__=None, actual_seq_lengths_key_in__=None, block_table_in__=None, sparse_indices_out_=None, layout_query="BSND", layout_key="PA_BSND", sparse_count=2048, sparse_mode=3, kernel_name="lightning_indexer_vllm", impl_mode = ""):
    ...
    origin_func_name = "lightning_indexer_vllm"
    ascendc_src_dir_ex = "lightning_indexer_vllm"
    ascendc_src_dir = "lightning_indexer_vllm"
    ascendc_src_file = "lightning_indexer_vllm.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Ascend C Operator LightningIndexerVllm, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "LightningIndexerVllm"
...
def op_select_format(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__=None, actual_seq_lengths_key_in__=None, block_table_in__=None, sparse_indices_out_=None, layout_query="BSND", layout_key="PA_BSND", sparse_count=2048, sparse_mode=3, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__, sparse_indices_out_, layout_query, layout_key, sparse_count, sparse_mode)
    result = check_op_cap("op_select_format", "LightningIndexerVllm", __inputs__, __outputs__, __attrs__)
...
def get_op_specific_info(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__=None, actual_seq_lengths_key_in__=None, block_table_in__=None, sparse_indices_out_=None, layout_query="BSND", layout_key="PA_BSND", sparse_count=2048, sparse_mode=3, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__, sparse_indices_out_, layout_query, layout_key, sparse_count, sparse_mode)
    result = check_op_cap("get_op_specific_info", "LightningIndexerVllm", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
