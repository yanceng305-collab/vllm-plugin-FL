...
from vllm_fl.dispatch.backends.vendor.ascend.distributed.kv_transfer.utils.mooncake_transfer_engine import global_te
from vllm_fl.dispatch.backends.vendor.ascend.distributed.kv_transfer.utils.utils import get_transfer_timeout_value
from vllm_fl.dispatch.backends.vendor.ascend.utils import enable_custom_op, is_vl_model
...
class KVCacheRecvingThread(threading.Thread):
    ...
    def _transfer_kv_cache(self, req_meta: dict[str, Any]):
        ...
        use_fused_op = ascend_envs.VLLM_FL_FUSION_OP_TRANSPOSE_KV_CACHE_BY_BLOCK
