...
from vllm_fl.dispatch.backends.vendor.ascend.distributed.kv_transfer.kv_pool.ascend_store.config_data import (
...
from vllm_fl.dispatch.backends.vendor.ascend.distributed.kv_transfer.kv_pool.ascend_store.kv_transfer import (
...
backend_map = {
    "mooncake": {
        ...
        "path": "vllm_fl.dispatch.backends.vendor.ascend.distributed.kv_transfer.kv_pool.ascend_store.backend.mooncake_backend",
    },
    "memcache": {
        "name": "MemcacheBackend",
        "path": "vllm_fl.dispatch.backends.vendor.ascend.distributed.kv_transfer.kv_pool.ascend_store.backend.memcache_backend",
    },
    "yuanrong": {
        "name": "YuanrongBackend",
        "path": "vllm_fl.dispatch.backends.vendor.ascend.distributed.kv_transfer.kv_pool.ascend_store.backend.yuanrong_backend",
    },
}
