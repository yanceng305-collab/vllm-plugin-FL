...
from vllm_fl.dispatch.backends.vendor.ascend.distributed.device_communicators.pyhccl_wrapper import (
    HCCLLibrary,
    aclrtStream_t,
    buffer_type,
    hcclComm_t,
...
from vllm_fl.dispatch.backends.vendor.ascend.utils import current_stream
