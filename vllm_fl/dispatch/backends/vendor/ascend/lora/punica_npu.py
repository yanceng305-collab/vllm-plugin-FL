...
from vllm_fl.dispatch.backends.vendor.ascend.lora.utils import refresh_all_lora_classes
...
class PunicaWrapperNPU(PunicaWrapperBase):
    ...
    def __init__(self, max_num_batched_tokens: int, max_batches: int, device: torch.device | str, **kwargs):
        ...
        if get_ascend_device_type() == AscendDeviceType._310P or (
            ...
            from vllm_fl.dispatch.backends.vendor.ascend.lora.lora_ops import (
                bgmv_expand,
                bgmv_expand_slice,
                bgmv_shrink,
                sgmv_expand,
