...
from vllm_fl.dispatch.backends.vendor.ascend.attention.utils import AscendCommonAttentionMetadata, split_decodes_and_prefills
from vllm_fl.dispatch.backends.vendor.ascend.ops.cv_linear import CVLinearWrapper
from vllm_fl.dispatch.backends.vendor.ascend.ops.linear import AscendUnquantizedLinearMethod
from vllm_fl.dispatch.backends.vendor.ascend.ops.rope_dsv4 import get_cos_and_sin_dsa
from vllm_fl.dispatch.backends.vendor.ascend.quantization.methods.w8a8_dynamic import AscendW8A8DynamicLinearMethod
...
class AscendDSABackend(AttentionBackend):
    ...
    @staticmethod
    def get_builder_cls():
        from vllm_fl.dispatch.backends.vendor.ascend.utils import enable_dsa_cp
    ...
    def get_impl_cls() -> type["DSAAttentionImpl"]:
        ...
        if enable_dsa_cp():
            from vllm_fl.dispatch.backends.vendor.ascend.attention.context_parallel.dsa_cp import AscendDSACPImpl
...
class AscendDSAMetadataBuilder(AttentionMetadataBuilder[AscendDSAMetadata]):
    ...
    def build_for_drafting(
        ...
        **kwargs,
        ...
        assert self.compressor_ratio <= 1, "vllm-plugin-FL only support SWA-layer for Deepseek-V4 now."
