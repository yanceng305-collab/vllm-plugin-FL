...
from vllm_fl.dispatch.backends.vendor.ascend.attention.attention_v1 import AscendAttentionState
from vllm_fl.dispatch.backends.vendor.ascend.attention.context_parallel.common_cp import AscendPCPMetadata, CPChunkedContextMetadata
...
from vllm_fl.dispatch.backends.vendor.ascend.ops.layer_shard_linear import (
    is_hidden_layer,
    post_process_after_loading_for_shard_weight_series,
    reach_layer_for_shard_weight_series,
    register_all_layers_to_shard_weight_series,
)
from vllm_fl.dispatch.backends.vendor.ascend.ops.rotary_embedding import get_cos_and_sin_mla
from vllm_fl.dispatch.backends.vendor.ascend.quantization.methods.w8a8_mxfp8 import AscendW8A8MXFP8DynamicLinearMethod
from vllm_fl.dispatch.backends.vendor.ascend.quantization.methods.w8a8_static import AscendW8A8LinearMethod
...
class AscendMLABackend(AttentionBackend):
    ...
    def get_builder_cls():
        if enable_cp():
            from vllm_fl.dispatch.backends.vendor.ascend.attention.context_parallel.mla_cp import AscendMlaCPMetadataBuilder
    ...
    def get_impl_cls() -> type["MLAAttentionImpl"]:
        if enable_cp():
            from vllm_fl.dispatch.backends.vendor.ascend.attention.context_parallel.mla_cp import AscendMlaCPImpl
