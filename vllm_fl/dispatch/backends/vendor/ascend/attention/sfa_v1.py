...
from vllm_fl.dispatch.backends.vendor.ascend.attention.context_parallel.common_cp import AscendPCPMetadata
from vllm_fl.dispatch.backends.vendor.ascend.attention.mla_v1 import MAX_O_PROJ_PREFETCH_SIZE, MLAPO_MAX_SUPPORTED_TOKENS
...
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.rope import rope_forward_triton_siso
from vllm_fl.dispatch.backends.vendor.ascend.quantization.methods import AscendW8A8LinearMethod
...
class AscendSFABackend(AttentionBackend):
    ...
    def get_builder_cls():
        if enable_cp():
            from vllm_fl.dispatch.backends.vendor.ascend.attention.context_parallel.sfa_cp import AscendSFACPMetadataBuilder
    ...
    def get_impl_cls() -> type["AscendSFAImpl"]:
        if enable_cp():
            from vllm_fl.dispatch.backends.vendor.ascend.attention.context_parallel.sfa_cp import AscendSFACPImpl
