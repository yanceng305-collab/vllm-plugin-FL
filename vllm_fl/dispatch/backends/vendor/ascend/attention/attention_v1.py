...
from vllm_fl.dispatch.backends.vendor.ascend.attention.context_parallel.common_cp import AscendMetadataForDecode, AscendMetadataForPrefill
from vllm_fl.dispatch.backends.vendor.ascend.attention.kvcomp_attn.attention_utils import (
...
from vllm_fl.dispatch.backends.vendor.ascend.ops.flashcomm2_oshard_manager import flashcomm2_oshard_manager
from vllm_fl.dispatch.backends.vendor.ascend.utils import weak_ref_tensors
from vllm_fl.dispatch.backends.vendor.ascend.worker.kvcomp_utils import KVCompMetaData
...
class AscendAttentionBackend(AttentionBackend):
    ...
    def get_impl_cls() -> type["AscendAttentionBackendImpl"]:
        if enable_cp():
            from vllm_fl.dispatch.backends.vendor.ascend.attention.context_parallel.attention_cp import AscendAttentionCPImpl
    ...
    def get_builder_cls() -> type["AscendAttentionMetadataBuilder"]:
        if enable_cp():
            from vllm_fl.dispatch.backends.vendor.ascend.attention.context_parallel.attention_cp import AscendAttentionCPMetadataBuilder
...
class AscendMetadata:
    ...
    # should simplified these parameters once attention schema in vllm-plugin-FL
    # is unified.
...
class AscendC8AttentionBackendImpl(AscendAttentionBackendImpl):
    ...
    (vllm_fl.dispatch.backends.vendor.ascend/quantization/methods/kv_c8.py)
