...
from vllm_fl.dispatch.backends.vendor.ascend.flash_common3_context import get_flash_common3_context
...
from vllm_fl.dispatch.backends.vendor.ascend.utils import ACL_FORMAT_FRACTAL_NZ, enable_dsa_cp, maybe_trans_nz
...
class AscendW8A8DynamicFusedMoEMethod(AscendMoEScheme):
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.warning_once(
                "[vllm-plugin-FL/W8A8_DYNAMIC] MC2 group metadata unavailable, "
    ...
    def apply(
        ...
        if zero_expert_num == 0 or zero_expert_type is None:
            assert router_logits.shape[1] == num_logical_experts, (
                "[vllm-plugin-FL/W8A8_DYNAMIC] Number of global experts mismatch "
        ...
        if self.multistream_overlap_gate:
            ...
            assert fc3_context is not None, (
                "[vllm-plugin-FL/W8A8_DYNAMIC] flash_common3 context is required when multistream_overlap_gate is enabled."
            )
