...
from vllm_fl.dispatch.backends.vendor.ascend.utils import ASCEND_QUANTIZATION_METHOD, AscendDeviceType, calc_split_factor, get_ascend_device_type
    ...
    def maybe_update_config(
        ...
        Args:
            ...
            revision: Optional revision (branch, tag, or commit hash) for
                remote repos.
        """
        from vllm_fl.dispatch.backends.vendor.ascend.quantization.utils import get_model_file
