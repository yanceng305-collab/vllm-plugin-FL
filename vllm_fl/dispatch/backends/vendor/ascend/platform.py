...
from vllm_fl.dispatch.backends.vendor.ascend.ascend_config import get_ascend_config, init_ascend_config
...
class NPUPlatform(Platform):
    ...
    def pre_register_and_update(cls, parser: FlexibleArgumentParser | None = None) -> None:
        ...
        if not is_310p():
            from vllm_fl.dispatch.backends.vendor.ascend.quantization import AscendCompressedTensorsConfig, AscendModelSlimConfig  # noqa: F401
        else:
            from vllm_fl.dispatch.backends.vendor.ascend._310p.quantization import AscendModelSlimConfig310  # noqa: F401
    ...
    def apply_config_platform_defaults(cls, vllm_config: VllmConfig) -> None:
        ...
        if pass_config.enable_sp and pass_config.sp_min_token_num is None:
            from vllm_fl.dispatch.backends.vendor.ascend.compilation.passes.sequence_parallelism import get_sp_min_token_num
    ...
    def check_and_update_config(cls, vllm_config: VllmConfig) -> None:
        from vllm_fl.dispatch.backends.vendor.ascend.quantization.utils import maybe_auto_detect_quantization
        ...
        # is supported by vllm-plugin-FL.
        if (
        ...
        if parallel_config and parallel_config.worker_cls == "auto":
            ...
            if is_310p():
                parallel_config.worker_cls = "vllm_fl.dispatch.backends.vendor.ascend._310p.worker_310p.NPUWorker310"
            elif ascend_config.xlite_graph_config.enabled:
                logger.info("openEuler Xlite enabled. See: https://atomgit.com/openeuler/GVirt/tree/master/xlite")
                parallel_config.worker_cls = "vllm_fl.dispatch.backends.vendor.ascend.xlite.xlite_worker.XliteWorker"
            else:
                parallel_config.worker_cls = "vllm_fl.dispatch.backends.vendor.ascend.worker.worker.NPUWorker"
        ...
        if ascend_config.recompute_scheduler_enable:
            ...
            from vllm_fl.dispatch.backends.vendor.ascend.core.recompute_scheduler import RecomputeSchedulerConfig
        ...
        if ascend_config.SLO_limits_for_dynamic_batch != -1:
            vllm_config.scheduler_config.scheduler_cls = (
                "vllm_fl.dispatch.backends.vendor.ascend.core.scheduler_dynamic_batch.SchedulerDynamicBatch"
            )
        ...
        if ascend_config.profiling_chunk_config.enabled:
            vllm_config.scheduler_config.scheduler_cls = (
                "vllm_fl.dispatch.backends.vendor.ascend.core.scheduler_profiling_chunk.ProfilingChunkScheduler"
            )
            import vllm_fl.dispatch.backends.vendor.ascend.patch.platform.patch_profiling_chunk  # noqa
        ...
        if ascend_config.enable_mc2_hierarchy_comm and get_ascend_config().enable_fused_mc2:
            raise ValueError(
                ...
                "Please disable VLLM_FL_ENABLE_FUSED_MC2 by setting it to 0."
            )

    @classmethod
    def import_kernels(cls) -> None:
        # Directly importing fl_ascend_C prevents ASCEND_RT_VISIBLE_DEVICES
        ...
        # to avoid this issue. See https://github.com/vllm-project/vllm-plugin-FL/pull/884.
    ...
    def get_attn_backend_cls(cls, selected_backend, attn_selector_config, num_heads: int | None = None):
        ...
        if selected_backend == AttentionBackendEnum.FLASH_ATTN and cls._validate_fa3_backend(key, attn_selector_config):
            return "vllm_fl.dispatch.backends.vendor.ascend.attention.fa3_v1.AscendFABackend"

        backend_map = {
            (True, False, False): "vllm_fl.dispatch.backends.vendor.ascend.attention.mla_v1.AscendMLABackend",
            (False, False, False): "vllm_fl.dispatch.backends.vendor.ascend.attention.attention_v1.AscendAttentionBackend",
            (True, True, False): "vllm_fl.dispatch.backends.vendor.ascend.attention.sfa_v1.AscendSFABackend",
            (True, False, True): "vllm_fl.dispatch.backends.vendor.ascend.attention.dsa_v1.AscendDSABackend",
        }
        backend_map_310 = {
            (
                False,
                False,
            ): "vllm_fl.dispatch.backends.vendor.ascend._310p.attention.attention_v1.AscendAttentionBackend310",
    ...
    def get_punica_wrapper(cls) -> str:
        return "vllm_fl.dispatch.backends.vendor.ascend.lora.punica_npu.PunicaWrapperNPU"
    ...
    def get_device_communicator_cls(cls) -> str:
        return "vllm_fl.dispatch.backends.vendor.ascend.distributed.device_communicators.npu_communicator.NPUCommunicator"
    ...
    def get_static_graph_wrapper_cls(cls) -> str:
        ...
        """
        return "vllm_fl.dispatch.backends.vendor.ascend.compilation.acl_graph.ACLGraphWrapper"  # noqa
    ...
    def set_additional_forward_context(
        ...
        from vllm_fl.dispatch.backends.vendor.ascend.ascend_forward_context import (
            get_mc2_mask,
            get_mrv2_in_profile_run,
            select_moe_comm_method,
        )
        from vllm_fl.dispatch.backends.vendor.ascend.ops.fused_moe.moe_comm_method import get_moe_comm_method
