...
if HAS_TRITON:
    from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.batch_invariant.matmul import (
    ...
    from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.batch_invariant.softmax import softmax_batch_invariant
