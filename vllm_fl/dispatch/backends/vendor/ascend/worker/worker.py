...
from vllm_fl.dispatch.backends.vendor.ascend.batch_invariant import init_batch_invariance
from vllm_fl.dispatch.backends.vendor.ascend.cpu_binding import bind_cpus
from vllm_fl.dispatch.backends.vendor.ascend.device_allocator.camem import CaMemAllocator
from vllm_fl.dispatch.backends.vendor.ascend.distributed.parallel_state import init_ascend_model_parallel
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.triton_utils import init_device_properties_triton
from vllm_fl.dispatch.backends.vendor.ascend.profiler.torch_npu_profiler import TorchNPUProfilerWrapper
...
from vllm_fl.dispatch.backends.vendor.ascend.worker.model_runner_v1 import NPUModelRunner
...
class NPUWorker(WorkerBase):
        ...
        **kwargs,
        ...
        if not envs_ascend.COMPILE_CUSTOM_KERNELS:
            logger.warning(
                ...
                "In most scenarios, without custom kernels, vllm-plugin-FL will not function correctly."
            )
        ...
        from vllm_fl.dispatch.backends.vendor.ascend import ops
    ...
    def init_device(self):
        ...
        if self.use_v2_model_runner:
            ...
            from vllm_fl.dispatch.backends.vendor.ascend.worker.v2.model_runner import NPUModelRunner as NPUModelRunnerV2
    ...
    def execute_model(
        ...
        # enable msMonitor to monitor the performance of vllm-plugin-FL
