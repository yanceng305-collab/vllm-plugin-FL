...
from vllm_fl.dispatch.backends.vendor.ascend.utils import set_weight_prefetch_method
from vllm_fl.dispatch.backends.vendor.ascend.worker.v2.aclgraph_utils import ModelAclGraphManager
from vllm_fl.dispatch.backends.vendor.ascend.worker.v2.attn_utils import build_attn_state
from vllm_fl.dispatch.backends.vendor.ascend.worker.v2.input_batch import AscendInputBatch, AscendInputBuffers
from vllm_fl.dispatch.backends.vendor.ascend.worker.v2.spec_decode.eagle import init_speculator
from vllm_fl.dispatch.backends.vendor.ascend.worker.v2.spec_decode.eagle.speculator import AscendEagleSpeculator
from vllm_fl.dispatch.backends.vendor.ascend.worker.v2.states import AscendRequestState
from vllm_fl.dispatch.backends.vendor.ascend.worker.v2.utils import torch_cuda_wrapper
...
class NPUModelRunner(GPUModelRunner):
    ...
    def __init__(self, vllm_config: VllmConfig, device: torch.device):
        ...
        # we define AscendEagleSpeculator in vllm_fl.dispatch.backends.vendor.ascend.worker.v2.spec_decode.eagle.speculator
    ...
    def prepare_inputs(
        ...
        if batch_desc.cg_mode == CUDAGraphMode.FULL:
            # This is only required for vllm-plugin-FL.
