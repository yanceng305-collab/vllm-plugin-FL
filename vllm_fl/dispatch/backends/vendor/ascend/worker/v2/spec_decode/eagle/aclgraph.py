...
# SPDX-FileCopyrightText: Copyright contributors to the vllm-plugin-FL project
...
from vllm_fl.dispatch.backends.vendor.ascend.worker.v2.aclgraph_utils import ModelWithContext
from vllm_fl.dispatch.backends.vendor.ascend.worker.v2.utils import communicator_switch
...
class PrefillEagleAclGraphManager(PrefillEagleCudaGraphManager):
    ...
    def __init__(
        ...
        # vllm-plugin-FL need to update draft graph params of attention backend.
