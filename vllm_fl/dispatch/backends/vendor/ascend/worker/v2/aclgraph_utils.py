...
from vllm_fl.dispatch.backends.vendor.ascend.compilation.acl_graph import set_graph_params, update_full_graph_params
...
class ModelAclGraphManager(ModelCudaGraphManager):
    ...
    def __init__(
        ...
        # vllm-plugin-FL need to update graph params of attention backend.
